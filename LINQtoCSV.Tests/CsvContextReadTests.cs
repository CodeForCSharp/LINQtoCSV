...
namespace LINQtoCSV.Tests
{
    ...
    public class CsvContextReadTests : Test
    {
        ...
        public void GoodFileUsingOutputFormatForParsingDatesCharUsEnglish()
        {
            ...
            var fileDescriptionNamesUs = new CsvFileDescription
            {
                SeparatorChar = ';',
            ...
            var expected = new[]
            {
                ...
                {
                    name = "AAAAAAAA",
                    startDate = new DateTime(2008, 5, 23)
                },
                new ProductDataParsingOutputFormat
                {
                    name = "BBBBBBBB",
                    startDate = new DateTime(2012, 5, 12)
                },
                new ProductDataParsingOutputFormat
                {
                    name = "CCCCCCCC",
                    startDate = new DateTime(2008, 12, 23)
                }
            };
...
dog house,    ""45,230,990"",29 Feb 2004, ,                  -56,        True,"""",                  FF10, ""12,008""";
            ...
            var expected = new[]
            {
                ...
                new ProductData
                {
                    name = "mouse trap",
                    weight = 45E-5,
                    startDate = new DateTime(1985, 1, 2),
                    launchTime = new DateTime(1988, 8, 7, 0, 0, 0),
                    nbrAvailable = 4030,
                    onsale = false,
                    shopsAvailable = @"This field has
a newline",
                    hexProductCode = 256,
                    retailPrice = 78300M,
...
and a quoted ""string"""
                ...
                new ProductData
                {
                    name = "dog house",
                    weight = 45230990,
                    startDate = new DateTime(2004, 2, 29),
                    launchTime = default(DateTime),
                    nbrAvailable = -56,
                    onsale = true,
                    shopsAvailable = "",
                    hexProductCode = 65296,
                    retailPrice = 12008M,
                    description = null
                }
            };
        ...
        public void GoodFileTabDelimitedNoNamesInFirstLineNLnl()
        {
            ...
            var fileDescriptionNonamesNl = new CsvFileDescription
            {
...
and a quoted ""string"""
            ...
            AssertRead(testInput, fileDescriptionNonamesNl, expected);
        }
